...
class FaceExtractor:
    ...
    def center_momentum(self, x, y, s, momentum=.3):
        """
        TODO: Kalman filter
        """
        ...
        x = (1-momentum)*x + momentum*self.coords[0]
        y = (1-momentum)*y + momentum*self.coords[1]
        s = (1-momentum)*s + momentum*self.coords[2]
        return x, y, s
...
def main():
    ...
    while True:
        ...
        if not (t==0 and b==0 and l==0 and r==0):
            ...
            x, y, s = f.center_momentum(x, y, s)
            print(f'x, y, s (momentum) = {x:.3f}, {y:.3f}, {s:.3f}')
